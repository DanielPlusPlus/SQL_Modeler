...
class PostgreSQLConnectionParamsDialogView(QDialog):
    ...
    def setupUI(self):
        if not self.objectName():
            self.setObjectName(u"PostgreSQLConnectionParamsDialog")
        self.resize(280, 180)
        self.setWindowTitle(u"PostgreSQL Database Connection Parameters")
        ...
        self.usernameLineEdit.setMaxLength(63)
        ...
        self.__databaseLabel = QLabel(u"Database", self)
        self.__databaseLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.databaseLineEdit = QLineEdit(self)
        databaseValidator = QRegularExpressionValidator(self.__databaseRegex, self.databaseLineEdit)
        self.databaseLineEdit.setValidator(databaseValidator)
        self.databaseLineEdit.setMaxLength(63)
        self.__horizontalLayout_5.addWidget(self.__databaseLabel)
        self.__horizontalLayout_5.addWidget(self.databaseLineEdit)
