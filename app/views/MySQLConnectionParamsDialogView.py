...
class MySQLConnectionParamsDialogView(QDialog, ConnectionParamsDialogInterface):
    ...
    def setupUI(self):
        if not self.objectName():
            self.setObjectName(u"MySQLConnectionParamsDialog")
        self.resize(280, 180)
        self.setWindowTitle(u"MySQL Database Connection Parameters")
        ...
        self.databaseLineEdit.setMaxLength(64)
